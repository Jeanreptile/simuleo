    ...
    return (
      <Modal>
        ...
        <ModalFooter>
          ...
          <Button bsStyle='success' onClick={function(){this.handleClick()}.bind(this)} >Yes</Button>
        </ModalFooter>
      </Modal>
    );
  },
...
var Body = React.createClass({
  ...
  render: function() {
    return (
      <Container id='body'>
        <Grid>
        <h1 className="text-center">Negociations - 23/10/2015 - MTI 2016</h1>
          <Row className='gallery-view marginTopper'>
            <Col xs={6} sm={4} collapseRight>
              <h3 className="text-center">Groups awaiting round validation</h3>
            </Col>
            <Col xs={6} sm={4} collapseRight>
              <h3 className="text-center">Groups working</h3>
            </Col>
            <Col xs={6} sm={4} collapseRight>
              <h3 className="text-center">Groups having finished</h3>
            </Col>
          </Row>
          <Row className='gallery-view'>
            <Col xs={6} sm={4} collapseRight>
              <GroupItem title='Team 1' state="INIT" subtitle='10th Dec - 12th Dec' url='/simul_negociation/config'/>
              <GroupItem title='Team 2' state="INIT" subtitle='10th Dec - 12th Dec' url='/simul_negociation/config'/>
              <GroupItem title='Team 3' state="INIT" subtitle='10th Dec - 12th Dec' url='/simul_negociation/config'/>
            </Col>
            <Col xs={6} sm={4} collapseRight>
              <GroupItem title='Team 23' state="ONGOING" subtitle='10th Dec - 12th Dec' url='/simul_negociation/config'/>
            </Col>
            <Col xs={6} sm={4} collapseRight>
              <GroupItem title='Team 12' state="COMPLETED" subtitle='10th Dec - 12th Dec' url='/simul_negociation/config'/>
              <GroupItem title='Team 9' state="COMPLETED" subtitle='10th Dec - 12th Dec' url='/simul_negociation/config'/>
              <GroupItem title='Team 7' state="COMPLETED" subtitle='10th Dec - 12th Dec' url='/simul_negociation/config'/>
            </Col>
          </Row>
        </Grid>
        {this.props.children}
