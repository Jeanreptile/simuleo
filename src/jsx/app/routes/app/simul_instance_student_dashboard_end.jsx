...
var Body = React.createClass({
  ...
  render: function() {
    ...
    return (
      <Container id='body'>
        <Grid>
          <h1 className="text-center">Negociations - 23/10/2015 - Final summary</h1>
          <Row style={{marginTop: 20}}>
            <Col sm={6}>
              <p>Message from your teacher</p>
            </Col>
          </Row>
          <Row style={{marginBottom: 10}}>
            <Col sm={6}>
              <Textarea disabled id='textareahorizontal' rows='3'>Great job!</Textarea>
            </Col>
          </Row>
          <Row>
            <Col xs={12}>
          ...
          <Row style={{textAlign:"center"}}>
            <Button style={{marginBottom: 5}} bsStyle='success'>Finish</Button>{' '}
          </Row>
        </Grid>
      </Container>
    );
